...
def test_level1_7_submit_without_answer_depends_on_cwd(tmp_path: Path, monkeypatch) -> None:
    level = Level1_7()
...
def test_level1_7_answer_is_ignored_when_in_final(tmp_path: Path, monkeypatch) -> None:
    level = Level1_7()
